  ...
  >
    ...
    <div class="normal">
      ...
      <div class="normal_img">
        <img :src="srcList.normal" :style="{'left':'-' + normal + 'px','width':(pictureInfo?.pixelX/(pictureInfo?.pixelY/200)) + 'px'}">
      </div>
    </div>
    <div class="compare">
      ...
      <div id="sign_div" class="compare_img">
        <img id="sign_img" :src="srcList.compare" :style="{'left':'-' + normal + 'px','width':(pictureInfo?.pixelX/(pictureInfo?.pixelY/200)) + 'px'}">
        <div 
  ...
  methods: {
    openDialog(signDivList) {
      ...
      this.$nextTick(()=>{
        ...
        document.getElementById('compare_img').parentNode.style.width = (this.pictureInfo.pixelX/(this.pictureInfo.pixelY/200)) + 'px'
        document.getElementById('normal_img').parentNode.style.width = (this.pictureInfo.pixelX/(this.pictureInfo.pixelY/200)) + 'px'
